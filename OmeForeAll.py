...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.gridLayout_2.addWidget(self.excelBtn_2, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.excelLabel_2, 1, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.sqlBtn_2, 0, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.runBtn_2, 0, 2, 2, 1)
